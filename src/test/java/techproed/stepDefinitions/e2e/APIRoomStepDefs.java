...
import static techproed.hooks.Hook.specification;
...
public class APIRoomStepDefs {
    ...
    public void aGetRequestIsSent() {
        ...
        specification.pathParams("first","api","second","rooms","third",DBRoomStepDefs.roomId);

        //set the expected data
        expectedData = new RoomPojo(UIMedunnaStepdefs.roomNumber,"SUITE",true,UIMedunnaStepdefs.expectedPrice,UIMedunnaStepdefs.expectedDescription);
